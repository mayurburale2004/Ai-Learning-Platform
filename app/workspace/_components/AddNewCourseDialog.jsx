      ...
      <DialogDescription asChild>
        <div className='flex flex-col gap-4 mt-3'>
             ...
             <div>
                ...
                <Input placeholder="Enter Number of chapters" type="number" onChange={(event)=>onHandleInputChange('noOfChapters',event?.target.value)}/>
             </div>
             ...
             <div>
                ...
                <Input placeholder="Enter category (Separated by Comma)" onChange={(event)=>onHandleInputChange('category',event?.target.value)}/>
             </div>
             <div className='mt-5'>
